...
//     */
	...
	public static void main(String[] args) {
		...
		System.out.println("multi thread run edilme suresi = "+(multiBitis-multiBasla));
...
class SingleThreadSayac {
	...
	public void sThreadSayac() {
		...
		for (int i = 1; i <= 10 ; i++) {// 10 tane islem var
			System.out.println("i "+i+" icin single calisan thread no: "+threadNo);
...
class MultiThreadSayac extends Thread{
	...
	public void run() {// thread'e is tanimi yapildi
		mThreadSayac();
	}
